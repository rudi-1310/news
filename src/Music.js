...
function Home() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`https://newsdata.io/api/1/news?apikey=pub_29932e01ef0a9358beee19ff50890449c6324&language=en&q=music`);
    ...
    return (
        <div className='h-screen  bg-slate-400 flex flex-row'>
            <div className='flex  flex-col w-1/5 h-full  justify-start items-start p-10 bg-white mb-5'>
                ...
                <div className='my-10  '>
                    <MenuItem path="/music" icon={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
                    </svg>} title='home' />
                    <MenuItem onClick={handleChange} icon={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
